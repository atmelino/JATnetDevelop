function makeAxisLabel(scene, zUp) {
	...
	var textGeom = new THREE.TextGeometry(first, {
		size : gridSize / 10,
		height : gridSize / 100,
		curveSegments : 3,
		font : "helvetiker",
	...
	var materialArray = [ materialFront, materialSide ];
	var textGeom = new THREE.TextGeometry(second, {
		size : gridSize / 10,
		height : gridSize / 100,
		curveSegments : 3,
		font : "helvetiker",
	...
	// Z
	var textGeom = new THREE.TextGeometry(third, {
		size : gridSize / 10,
		height : gridSize / 100,
		curveSegments : 3,
		font : "helvetiker",
